...
class _QuickCalorieWidgetState extends State<QuickCalorieWidget> {
  ...
  Future<void> _loadUserProfile() async {
    try {
      ...
      // Hata durumunda loglamaya gerek yok, sessizce devam et
  ...
  Future<void> _calculateQuickCalories() async {
    ...
    try {
      // Static method çağrısını düzelt - basit string listesi gönder
      final result = CalorieCalculatorService.calculateCaloriesFromFoodList([food]);
      ...
      if (mounted) {
        ...
        debugPrint('Kalori hesaplama hatası: $e');
      }
    }
  }
  ...
  Widget _buildResultCard() {
    ...
    final targetCalories = _userProfile != null ? 
        CalorieCalculatorService.calculateDailyCalorieNeeds(
    ...
    final percentage = (calories / targetCalories * 100).clamp(0, 100);
